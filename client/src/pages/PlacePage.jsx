...
export default function PlacePage(){
    ...
    if(showAllPhotos){
        return(
            <div className="absoulte inset-0 bg-white min-h-screen">
                <div className="p-8 grid gap-4">
                    <div>
                        <h2 className="text-3xl">Photos of {place.title}</h2>
                        <button onClick={() => setShowAllPhotos(false)} className="fixed right-12 top-20 flex gap-1 py-2 px-2 rounded-2xl shadow shadow-black">
    ...
    return(
        <div className="mt-4 bg-gray-100 -mx-8 px-8 pt-8">
            ...
            <a className="flex my-2 block front-semibold underline" target="_blank" href={'https://maps.google.com/?g='+place.title}>
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-6 h-6">
